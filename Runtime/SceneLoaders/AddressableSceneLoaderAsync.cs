...
namespace MyGameDevTools.SceneLoading.AddressablesSupport
{
    public class AddressableSceneLoaderAsync : IAddressableSceneLoaderAsync
    {
        ...
        public void UnloadScene(IAddressableLoadSceneReference sceneInfo) => _ = UnloadSceneAsync(sceneInfo);
        ...
        public async Task UnloadSceneAsync(IAddressableLoadSceneReference sceneInfo) => await _sceneManager.UnloadSceneAsync(sceneInfo);
