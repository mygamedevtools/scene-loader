...
As versões são assinadas com a [assinatura de pacotes do UPM](https://docs.unity3d.com/6000.3/Documentation/Manual/upm-signature.html), que o **Package Manager** verifica a partir do **Unity 6.3**. O método que você escolher decide se você recebe essa assinatura:
...
4. Clique `Download` ou `Update`, dependendo do estado local de cache.
5. Clique `Import`.
